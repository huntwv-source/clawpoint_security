...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Auto-redirect to blog dashboard after successful signup
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="mb-8 text-center stalk-in">
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            <span className="text-[var(--night-vision)] font-mono text-xs tracking-widest">CREATE ACCOUNT</span>
            <div className="w-12 h-px bg-[var(--tactical-green)]" />
          </div>
          <h1 className="text-2xl font-bold text-white font-mono tracking-wider">REGISTRATION</h1>
